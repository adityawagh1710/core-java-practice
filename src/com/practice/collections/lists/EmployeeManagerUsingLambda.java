...
public class EmployeeManagerUsingLambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Male   Avg Salary : %.2f%n", salaryCounts[0] > 0 ? salaryTotals[0] / salaryCounts[0] : 0);
        System.out.printf("Female Avg Salary : %.2f%n", salaryCounts[1] > 0 ? salaryTotals[1] / salaryCounts[1] : 0);
        ...
        employees.forEach(e -> {
            if (!departments.contains(e.getDeptName())) departments.add(e.getDeptName());
        });
